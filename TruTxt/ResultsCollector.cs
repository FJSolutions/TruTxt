   ...
   IEnumerable<KeyValuePair<string, ValidationResult>>
{
   ...
   /// <summary>
   /// Maps this <see cref="ResultsCollector"/> through a <see cref="TruReader"/> data mapper and then to a
   /// <param name="valid"></param> function.
   /// <para>The point of the <param name="dataProcessor"></param>
   /// function is to safely transform valid text input to strongly typed values.</para> 
   /// </summary>
   ...
   /// <returns>The new <see cref="ResultsCollector"/></returns>
   [Pure]
   public static ResultsCollector Empty()
   {
